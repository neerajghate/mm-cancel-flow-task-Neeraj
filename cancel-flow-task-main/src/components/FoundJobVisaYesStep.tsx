    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-gray-600">Step  of 3</span>
        </div>
      ...
      <div className="grid grid-cols-1 gap-8 px-8 py-8 sm:grid-cols-2">
        ...
        <div className="sm:pr-6">
          <h1 className="text-3xl sm:text-4xl font-semibold leading-tight text-gray-900">
            ...
            <br /> let’s help you secure your visa.
          </h1>
          ...
          <div className="mt-6 space-y-4">
            ...
            {/* Follow-up field (YES vs NO copy) */}
            {answer !== '' && (
              <div className="mt-4">
                {answer === 'no' ? (
                  <>
                    ...
                    <p className="text-sm text-gray-700 mt-2">Which visa would you like to apply for?*</p>
                  </>
                ) : (
